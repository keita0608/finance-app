...
<div>
	...
	<HelpSection title="科目の編集・削除">
		...
		<HelpNote type="warning">
			<p>
				システム初期科目の科目名・カテゴリは変更できません。ただし、デフォルト消費税区分・家事按分設定・証憑不要設定は変更可能です（ペンアイコンから）。
			</p>
		</HelpNote>
	</HelpSection>

	<HelpSection title="お気に入り科目">
		<p>
			よく使う科目をお気に入りに登録すると、仕訳入力時の科目選択ダイアログの上部に表示されます。
		</p>
		<ul class="mt-2 ml-4 list-disc space-y-1">
			<li>各科目の☆ボタンをクリックすると、お気に入りに追加/解除できます（システム科目も対象）</li>
			<li>仕訳入力中の科目選択ダイアログ内の☆ボタンでも切り替えできます</li>
			<li>お気に入りがある場合、科目選択ダイアログのカテゴリ別一覧は折りたたまれ、▼で展開できます</li>
		</ul>
		<HelpNote type="tip">
			<p>
				フリーランスで普段使う科目は10個程度のことが多いため、お気に入り登録で科目選択が大幅に速くなります。
			</p>
		</HelpNote>
	</HelpSection>

	<HelpSection title="デフォルト消費税区分">
		<p>
		...
		<ol class="ml-4 list-decimal space-y-2">
			<li>科目の編集アイコン（ペン）または「%」アイコンをクリック</li>
			<li>「デフォルト消費税区分」を選択</li>
			<li>「保存」をクリック</li>
		</ol>

		<p class="mt-4"><strong>カテゴリ別の選択肢：</strong></p>
		<HelpTable
			headers={['カテゴリ', '選択可能な消費税区分']}
			rows={[
	...
	<HelpSection title="既存仕訳の消費税区分を更新">
		<p>
			勘定科目のデフォルト消費税区分を変更した際、その科目を使用している既存の仕訳も一括で更新できます。
		</p>
		<ol class="ml-4 list-decimal space-y-2">
			<li>科目のデフォルト消費税区分を変更</li>
			<li>確認ダイアログが表示される</li>
			<li>「既存の仕訳も一括で更新する」にチェック</li>
			<li>「更新する」をクリック</li>
		</ol>
		<HelpNote type="info">
			<p>
	...
	<HelpSection title="証憑不要科目">
		<p>
			電車・バスなど領収書が発行されない取引に使う科目（例:
			旅費交通費）は、科目の編集で「証憑不要科目」をオンにできます。
		</p>
		<ul class="mt-2 ml-4 list-disc space-y-1">
			<li>オンにすると、仕訳帳の「証憑未添付ハイライト」（アンバー色表示）の対象外になります</li>
			<li>
				インボイス制度でも3万円未満の公共交通機関運賃は帳簿記載のみで仕入税額控除が可能です（公共交通機関特例）
			</li>
		</ul>
		<HelpNote type="info">
			<p>
				タクシー・宿泊など領収書が発行される取引が混在する科目でオンにすると、それらの添付漏れにも気づけなくなる点にご注意ください。
			</p>
		</HelpNote>
	</HelpSection>
</div>
